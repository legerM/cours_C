...
extern osMessageQueueId_t Queue_send_HuartHandle;
extern osMessageQueueId_t Queue_read_HuartHandle;
/**
...
LedControlReturnCode setLedColor(const unsigned char row,
	...
	osMessageQueuePut(Queue_send_HuartHandle,buffer,0,10);
...
//	osMessageQueuePut(&Queue_send_HuartHandle,message,0,0);
//
//	return LCRC_OK;
//}
...
char readbutton(char *pReadData, char DataSize)
{
	...
	if(osMessageQueueGet(Queue_read_HuartHandle, buffer,0,10) == osOK)
	{
