...
extern osSemaphoreId_t semaphore_led;
///////////////////////////////////////////////////////////////////////////////
...
int main(void)
{
	// Initialisation du mat��riel NE RIEN METTRE AVANT
	HAL_Init();
	SystemClock_Config();
	MX_GPIO_Init();
	...
	/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
	/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
	/* C'est entre c'est 2 double lignes de % que vous pouvez d��marrer vos   */
	/* t��ches et mettre votre code perso   */


	osThreadNew (thread_red_led, NULL, NULL);
	osThreadNew(thread_blue_led, NULL,NULL);
	osThreadNew(thread_green_led,NULL,NULL);
	osThreadNew(thread_serial,NULL,NULL);
	semaphore_led = osSemaphoreNew (1,0, NULL);
	...
	// D��marrage du micro noyau. Cette fonction est en quelque sorte le micro noyau
